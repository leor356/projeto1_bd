...
for row in ur:
    # Delegacia
    delegacias.add((row[22], row[23]))

    # Pessoas
    pessoas.add((row[28], row[29], row[30], row[31], row[32], row[33], row[34], row[35], row[36], row[37], row[38], row[39], row[40], row[41], row[42], row[43]))

    # Ocorrencias
    ocorrencias.add((row[1], row[5], row[6], row[7], row[10], row[17], row[18], row[20], row[24], row[25], row[26], row[27]))

    # BO
    bos.add((row[0], row[1], row[2], row[3], row[4], row[8], row[9], row[11], row[21], row[22], row[23]))

    # Endereco
    enderecos.add((row[12], row[13], row[14], row[15], row[16], row[17], row[18], row[19]))

    # Veiculo
    veiculos.add((row[44], row[45], row[46], row[47], row[48], row[49], row[50], row[51]))
